...
import { Search, Home, Book as BookIcon, Heart, Bookmark as BookmarkIcon, ChevronLeft } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.mainContent}>
        ...
        <View style={styles.bookGrid}>
          ...
          {books.length === 0 && loadingState === 'success' && (
        ...
        {loadingState === 'loading' && <ActivityIndicator style={{ marginVertical: 20 }} />}
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity onPress={() => { setCurrentView('all-books'); setCurrentPage(1); }} style={styles.navItem}>
